...
export default function AdminLayout() {
  ...
  return (
    <div className="flex h-screen bg-[#130b05] overflow-hidden">
      <Helmet>
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        {/* Mobile topbar */}
        <div className="md:hidden flex items-center gap-3 px-4 py-3 bg-[#0d0804] border-b border-orange-900/20 shrink-0">
          <button
          ...
          <div className="flex items-baseline gap-0.5">
            <span className="text-lg font-black text-orange-500">Alta</span>
